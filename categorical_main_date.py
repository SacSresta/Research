from models.categorical_random_processor import preprocess_data_by_date, scaling_function,preprocess_data,classifier_models,train_model,grid_optimize_model,random_optimize_model,get_param_grids,get_data,save_artifacts
...
def normal_run(lag=60):
    dir = r'C:\Users\sachi\Documents\Researchcode\Conferance_sentiment_categorical'
