from models.dl_model import prepare_data, build_gru_model, plot_loss, give_path,final_preprocessing, split_data,scaling_func,compare_results,plot_equity_comparison,get_lstm_stats,get_actual_stats
import os
...
if __name__ == "__main__":
    ...
    print(summary_df)
    summary_df.to_csv("gru_summary.csv", index=True)  # Save as CSV
