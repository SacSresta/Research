...
def classifier_models():
    classifiers = {
        ...
        'Random Forest': RandomForestClassifier(max_depth=10, min_samples_split=10, n_estimators=50, random_state=42),
        'XGBoost': XGBClassifier(learning_rate=0.01, max_depth=3, n_estimators=100, eval_metric='logloss', n_jobs=1, random_state=42),
        ...
        'SGD Classifier': SGDClassifier(loss='log_loss', alpha=0.001, random_state=42),
        'MLP': MLPClassifier(hidden_layer_sizes=(100,), max_iter=1000, random_state=42),
        'LGBMClassifier': LGBMClassifier(n_estimators=100, learning_rate=0.05, max_depth=5, boosting_type='gbdt', random_state=42)
    }
    return classifiers
